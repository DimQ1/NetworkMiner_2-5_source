...
namespace PacketParser.Packets {
    ...
    public class IPv4Packet : AbstractPacket, IIPPacket {
        ...
        private const ushort MAX_JUMBO_FRAME_SIZE = 9038;//I've seen VirtualBox use 11254 Bute frames internally
        ...
        public byte NextRFC1700Protocol { get { return this.protocol; } }
        ...
        internal IPv4Packet(Frame parentFrame, int packetStartIndex, int packetEndIndex) : base(parentFrame, packetStartIndex, packetEndIndex, "IPv4") {
            ...
            if ((parentFrame.Data[packetStartIndex] >> 4) != 0x04) {
                ...
                throw new ArgumentException("Invalid IPv4 header (IP Version != 4(" + (parentFrame.Data[packetStartIndex] >> 4) + ")");
            }
