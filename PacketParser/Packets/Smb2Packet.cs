        ...
        */
        ...
        public override IEnumerable<AbstractPacket> GetSubPackets(bool includeSelfReference) {
            ...
            if (!this.IsResponse || this.ntStatus == NT_STATUS_SUCCESS || this.ntStatus == NT_STATUS_MORE_PROCESSING_REQUIRED) {
                ...
                else if(!this.IsResponse && this.opCode == (short)OP_CODE.SetInfo) {//0x11
                    yield return new Smb2SetInfoRequest(this, this.PacketStartIndex + this.headerLength, this.PacketEndIndex);
                }
            }
