            ...
            if (iec104Packet.AsduData != null && iec104Packet.AsduData.Length > 0) {
                ...
                try {
                    while (parameters.Count < iec104Packet.AsduInformationObjectCount && ioaOffset < iec104Packet.AsduData.Length - iec104Packet.Settings.ioaLength) {
                        ...
                        string ioaString = "IOA " + asduIOA.ToString();
                        ...
                        if (iec104Packet.AsduTypeID.Value == 1) {
                            ...
                            parameters.Add(ioaString, siq.ToString());
                        }
                            ...
                            parameters.Add(ioaString, diq.ToString());
                        }
                        //TODO: 7
                            ...
                            parameters.Add(ioaString, nva.ToString() + " (" + qds.ToString() + ")");
                            ...
                            Packets.IEC_60870_5_104Packet.QDS qds = new Packets.IEC_60870_5_104Packet.QDS(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += qds.Length;
                            parameters.Add(ioaString, sva.ToString() + " (" + qds.ToString() + ")");
                            ...
                            Packets.IEC_60870_5_104Packet.QDS qds = new Packets.IEC_60870_5_104Packet.QDS(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += qds.Length;
                            parameters.Add(ioaString, binary32Float.ToString() + " (" + qds.ToString() + ")");
                            ...
                            parameters.Add(ioaString, siq.ToString() + " " + time.ToString());
                        }
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, diq.ToString() + " " + time.ToString());
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, nva.ToString() + " (" + qds.ToString() + ") " + time.ToString());
                        }
                        //TODO: 35
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, binary32Float.ToString() + " (" + qds.ToString() + ")" + time.ToString());
                            ...
                            parameters.Add(ioaString, sco.ToString());
                        }
                            ...
                            parameters.Add(ioaString, dco.ToString());
                        }
                            ...
                            parameters.Add(ioaString, binary32Float.ToString() + " (" + qos.ToString() + ")");
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, sco.ToString() + " " + time.ToString());
                        }
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, dco.ToString() + " " + time.ToString());
                        }
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, nva.ToString() + " ("+qos.ToString()+") " + time.ToString());
                        }
                            ...
                            Packets.IEC_60870_5_104Packet.CP56Time2a time = new Packets.IEC_60870_5_104Packet.CP56Time2a(iec104Packet.AsduData, ioaOffset);
                            ioaOffset += time.Length;
                            parameters.Add(ioaString, binary32Float.ToString() + " (" + qos.ToString() + ") " + time.ToString());
                        }
                        //TODO: 70 (JavaRMI_and...)
                            ...
                            parameters.Add(ioaString, qoi.ToString());
                        }
                        /*
                        ...
                        parameters.Add(ioaString, nva.ToString());
                    }*/
                        //TODO: P_ME_NA_1 - 110 - Parameter of measured value, normalized value
                            ...
                            if (bytesPerValue > 0) {
                                ...
                                parameters.Add(ioaString, ioaValueString);
                            }
