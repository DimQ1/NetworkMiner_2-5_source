    ...
    class DhcpPacketHandler : AbstractPacketHandler, IPacketHandler {
        ...
        private void ExtractData(ref NetworkHost sourceHost, NetworkHost destinationHost, Packets.DhcpPacket dhcpPacket) {
            ...
            if(optionParameterList.Count > 0) {
                ...
                if (udpPacket != null) {
                    Events.ParametersEventArgs ea = new Events.ParametersEventArgs(dhcpPacket.ParentFrame.FrameNumber, sourceHost, destinationHost, udpPacket.TransportProtocol, udpPacket.SourcePort, udpPacket.DestinationPort, optionParameterList, dhcpPacket.ParentFrame.Timestamp, "DHCP Option");
