...
namespace NetresecShared
{
    public class ApiUtils {
        ...
        public static Version GetLatestVersion(string productCode, out string releasePost, out string downloadUrl) {
            ...
            PacketParser.Utils.Logger.Log("ServicePointManager.SecurityProtocol = " + ServicePointManager.SecurityProtocol.ToString(), System.Diagnostics.EventLogEntryType.Information);
